...
/*
class User{
    constructor(firstName, lastName, age, gender, username, password, email, like, matches){
...
var Mads = new User("Mads", "Larsen", 18, "Hankøn", "Mads18", "hej12345", "mads@larsen.com", "Mille, Christian, Emilie", "Mille, Christian, Emilie")
var Mille = new User("Mille", "Hansen", 25, "Hunkøn", "Mille25", "hallo12345", "mille@gmail.com", "Mads, Sofie, Emilie", "Mads, Sofie")
var Christian = new User("Christian", "Nielsen", 23, "Hankøn", "Christian23", "hi12345", "christian@hotmail.com",  "Sofie", "Mads, Emilie")
var Emilie = new User("Emilie", "Mikkelsen", 19, "Hunkøn", "Emilie19", "EM1800", "emilie@yahoo.com", "Mads, Christian","Mads, Christian")
